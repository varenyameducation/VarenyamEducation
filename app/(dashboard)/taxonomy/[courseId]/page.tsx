...
import { Plus, MoreVertical, Pencil, Trash2, Layers, AlertCircle } from 'lucide-react'
...
export default function CourseDetailPage() {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: (result) => {
      if (result.ok) {
        setErrorMsg(null)
        qc.invalidateQueries({ queryKey: ['taxonomy', 'chapters', params.courseId] })
      } else {
            ...
            >
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  ...
                  <DropdownMenuItem
                    onSelect={() => deleteMutation.mutate(chapter.id)}
